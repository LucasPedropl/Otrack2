							...
							<table className="w-full text-left text-sm border-collapse min-w-[500px]">
								<thead>
									...
									>
										...
										<th
											className="p-4 font-medium w-32 text-center"
											style={{
												color: currentTheme.colors
													.textSecondary,
											}}
							...
							{filteredSites.map((site) => (
								...
								>
									...
									<div className="flex items-center gap-4 mb-4">
										<div
											className="p-3 rounded-xl bg-opacity-10 shadow-inner"
											style={{
									...
									<div
										className="mt-4 pt-4 border-t flex justify-between items-center text-sm"
										style={{
											borderColor:
									...
									>
										...
										<span className="font-medium px-2 py-0.5 rounded bg-green-500/10 text-green-600 text-xs uppercase tracking-wide">
											Ativo
										</span>
									</div>
								</div>
				...
				>
					...
					>
						...
						<p
							...
							style={{ color: currentTheme.colors.textSecondary }}
						>
							Tem certeza que deseja excluir esta obra? Todos os
							dados vinculados a ela (estoque, empréstimos) também
							serão perdidos.
						</p>
