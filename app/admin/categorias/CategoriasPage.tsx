...
import { Plus, Search, Tag, Trash2, Edit, AlertTriangle, X } from 'lucide-react';
  ...
  return (
    <>
      ...
      <BottomActionsBar 
        ...
        onDeleteSelected={hasPermission('orcamento_categorias', 'delete') ? handleBulkDeleteClick : undefined}
